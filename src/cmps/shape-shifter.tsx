...
export function ShapeShifter({ eventBus, type, idx, name, onTransformShape, onDelete }: { eventBus: Function, idx: number, type: string, name: string, onTransformShape: Function, onDelete: Function }) {
    ...
    return (<div className="options flex center">
        ...
        {type !== 'factory' && <RemoveIcon onDelete={onDelete} />}
